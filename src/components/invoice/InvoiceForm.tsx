...
export default function InvoiceForm({
  ...
  const validate = (): boolean => {
    ...
    if (!formData.senderPostCode.trim())
    ...
    if (!formData.clientPostCode.trim())
    ...
    items.forEach((item, index) => {
      ...
      if (item.quantity <= 0)
        newErrors[`item_${index}_quantity`] = "must be > 0";
  ...
  return (
    ...
    bg-[var(--color-card)] overflow-y-auto
      ...
      >
        <div style={{ padding: "48px 56px" }}>
          <h2 className="font-bold text-[1.5rem] text-[var(--color-text-primary)] mb-10 tracking-[-0.5px]">
            {isEditMode ? (
              <>
                Edit <span className="text-[var(--color-text-muted)]">#</span>
                {invoice.id}
              </>
            ) : (
              "New Invoice"
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("senderPostCode", e.target.value)
                    }
                  />
                </div>
                <div className="col-span-2 md:col-span-1">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("senderCountry", e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("clientPostCode", e.target.value)
                    }
                  />
                </div>
                <div className="col-span-2 md:col-span-1">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("clientCountry", e.target.value)
                    }
                  />
                </div>
              </div>
          ...
          <div className="mb-10">
            <h3 className="text-[1.125rem] font-bold text-[#777F98] mb-6">
              Item List
            </h3>
                ...
                <div key={item.id}>
                  ...
                  <div className="grid grid-cols-[1fr_24px] md:grid-cols-[1fr_60px_100px_80px_24px] gap-4 items-center">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M11.583 3.556H8.944V2.61A1.611 1.611 0 007.333 1H5.667a1.611 1.611 0 00-1.611 1.61v.946H1.417a.5.5 0 000 1h.278l.5 9.278A1.5 1.5 0 003.69 15h5.617a1.5 1.5 0 001.496-1.166l.5-9.278h.278a.5.5 0 100-1zM5.056 2.61a.611.611 0 01.611-.61h1.666a.611.611 0 01.611.61v.946H5.056V2.61zm5.122 10.668a.5.5 0 01-.499.389H3.69a.5.5 0 01-.499-.389L2.7 4.556h7.6l-.122 8.722z"
                          fill="currentColor"
                        />
                      </svg>
                    </button>
          ...
          <div
            className={`flex items-center gap-3 ${isEditMode ? "justify-end" : "justify-between"}`}
          >
            {isEditMode ? (
              <div
                style={{
